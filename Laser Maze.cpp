...
void printBoard(int y, int x, int rex) {
	...
	for (int i = 0; i < 31; i += 1) {
		for (int j = 0; j < 31; j += 1) {
			...
			else if (i == 0 && j == 0) cout << "忙";
			else if (i == 0 && j == 30) cout << "忖";
			else if (i == 30 && j == 0) cout << "戌";
			else if (i == 30 && j == 30) cout << "戎";
			else if (i == 0 && j % 6 == 0) cout << "成";
			else if (i == 30 && j % 6 == 0) cout << "扛";
			else if (i % 6 == 0 && j == 0) cout << "戍";
			else if (i % 6 == 0 && j == 30) cout << "扣";
			else if (i % 6 == 0 && j % 6 == 0) cout << "托";
			else if (i % 6 == 0) cout << "式式";
			else if (j % 6 == 0) cout << "弛";
			else {
